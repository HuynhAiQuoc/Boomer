 ...
 * Lop dinh nghia PlayGame(choi game), ap dung thread: dung de choi duoc nhieu man hinh cung luc
 * 
 */
public class PlayGame implements Observer, Runnable {
	...
	/**
	 * Constructor
	 * @param mContainer: tham so truyen vao la mot bien co kieu la MyContainer
	 *  + MyContainer: la lop dung de chua cac tag(the) trong game
	 *  + Manager: la lop dung xu ly hanh dong trong game
	 *  + Thread: xu ly da tien trinh
	 */
	...
	/**
	 * Phuong thuc chon nhan vat
	 * @param type: + 1: Nhan vat thu nhat(Be Bong)
	 *              + 2: Nhan vat thu hai(Kho Kho)
	 *              + 3: Nhan vat thu ba(Tia chop)
	 *              + 4: Nhan vat thu bon(Ti Banh)
	 */
	...
	/**
	 * Phuong thuc dung de them cac button_Menu
	 */
	...
	/**
	 * Phuong thuc dung de thiet lap diem so
	 */
	...
	/**
	 * Thiet lap do hoa cho cac nhan vat
	 */
	...
	/**
	 * Phuong thuc dung de thuc hien hanh dong cho cac nhan vat(characters) trong game
	 */
	@Override
	public void run() {
		while (IS_RUNNING) {
