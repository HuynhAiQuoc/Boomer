 ...
 * Lop dinh nghia  myContainer(lop chua) cac tag(the) trong game:
 *  + tag_menu(the menu) - Class: MenuView
 *  + tag_playgame(the choi game) - Class: PlayGame
 *  + tag_option(the lua chon) - Class: Option
 *  + tag_hightscore(the diem so cao) - Class: HightScorePanel
 *  + tag_actor(the nhan vat) - Class: ChooseActor
 */
public class MyContainer {
	...
	/**
	 * Constructor
	 * @param gameView: tham so truyen vao mot bien co kieu la GameView
	 * GameView: lop dung de hien thi man hinh tro choi
	 */
