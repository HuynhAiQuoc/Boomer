 ...
 * Lop dinh nghia ve hanh dong chon nhan vat cua nguoi choi
 */
public class ChooseActor {
	...
	/**
	 * Phuong thuc load(tai) hinh anh nhan vat
	 */
	...
	/**
	 * Phuong thuc them xu ly su kien cho nhan vat
	 * @param adapter: tham so truyen vao co kieu MouseAdapter
	 * MouseApdater: xu ly su kien con chuot
	 */
	...
	/**
	 * Thiet lap man hinh chon nhan vat
	 */
	...
	/**
	 * 
	 * @param x: tham so truyen vao bieu thi theo truc x(Ox)
	 * @param y: tham so truyen vao bieu thi theo truc y(Oy)
	 * @param ImageIcon: tham so truyen vao duong dan hinh anh
	 * @return
	 */
